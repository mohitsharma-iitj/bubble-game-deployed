// Importing Sound Effects"{{ url_for('static', filename='js/music/style.css') }}""{{ url_for('static', filename='js/music/introSong.mp3') }}"
const introMusic = new Audio('/static/music/introSong.mp3');
const shootingSound = new Audio('/static/music/shoooting.mp3');
const killEnemySound = new Audio('/static/music/killEnemy.mp3');
const gameOverSound = new Audio('/static/music/gameOver.mp3');
const heavyWeaponSound = new Audio('/static/music/heavyWeapon.mp3');
const hugeWeaponSound = new Audio('/static/music/hugeWeapon.mp3');
