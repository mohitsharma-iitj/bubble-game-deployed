// Importing Sound Effects"{{ url_for('static', filename='js/music/style.css') }}"
const introMusic = new Audio("{{ url_for('static', filename='js/music/introSong.mp3') }}");
const shootingSound = new Audio("{{ url_for('static', filename='js/music/shoooting.mp3') }}");
const killEnemySound = new Audio("{{ url_for('static', filename='js/music/killEnemy.mp3') }}");
const gameOverSound = new Audio("{{ url_for('static', filename='js/music/gameOver.mp3') }}");
const heavyWeaponSound = new Audio("{{ url_for('static', filename='js/music/heavyWeapon.mp3') }}");
const hugeWeaponSound = new Audio("{{ url_for('static', filename='js/music/hugeWeapon.mp3') }}");
